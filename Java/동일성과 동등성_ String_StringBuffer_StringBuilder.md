...
![String_5.png](./image/String_5.png)
...
![String_6.png](./image/String_6.png)
...
![String_7.png](./image/String_7.png)
...
- StringBuffer와 StringBuilder의 차이점은 동기화 여부임
    ...
    ![String_3.png](./image/String_3.png)
    
    StringBuffer 클래스의 내부를 살펴보면, synchronized 키워드를 사용하여 메소드를 선언함 
    
    ![String_4.png](./image/String_4.png)
