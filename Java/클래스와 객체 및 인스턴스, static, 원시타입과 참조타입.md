# 클래스/객체/인스턴스, static과 non-sstatic, 원시타입/참조타입
...
- Java1.5부터 auto boxking/unboxing이 추가되어 명시적으로 원시타입을 참조타임을 감싸주지 않아도 자동으로 boxing/unboxing해준다. (하지만 메모리 누수의 원인이 될 수 있음)
